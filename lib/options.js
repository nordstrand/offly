...
module.exports = {
    ...
    printHelp : function () {
        ...
        console.log();
        console.log("scrape  - scrape urls");
        console.log("  --crawl_url=<url to crawl>");
        console.log("  --recursive follow links");
        console.log("  --include=<reg exp> links to matching url:s");
        console.log("  --exclude=<reg exp> links to matching url:s");
        console.log();
        ...
        console.log( "  --sslDomain=<ssl domain to intercept>, '*' will intercept any domain (using a generated self-signed certificate)");
