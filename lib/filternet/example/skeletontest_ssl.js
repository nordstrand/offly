...
// (just headers)
myProxy.on('interceptRequest', function (requestInfo, response, callback) {
...
myProxy.on('interceptResponseContent', function (buffer, response, isSsl, charset, request, callback) {
    callback(buffer);
});
